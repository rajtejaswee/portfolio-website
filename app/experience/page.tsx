          ...
          <div className="group relative w-full bg-white/10 backdrop-blur-lg border border-white/30 rounded-[30px] p-6 md:p-10 text-white transition-all duration-300 hover:bg-white/20 hover:border-white/50 hover:shadow-[0_0_30px_rgba(255,255,255,0.1)]">
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-6">
              <div>
                ...
                <p className="font-helvetica font-regular text-medium base text-gray-200 tracking-[-0.9px] text-end">
                  Feb 2024 - Oct 2024
                </p>
              </div>
          ...
          <div className="group relative w-full bg-white/10 backdrop-blur-lg border border-white/30 rounded-[30px] p-6 md:p-10 text-white transition-all duration-300 hover:bg-white/20 hover:border-white/50 hover:shadow-[0_0_30px_rgba(255,255,255,0.1)]">
            ...
            <div className="font-helvetica text-sm md:text-[1.05rem] leading-[1.6] text-gray-100 text-justify font-light tracking-wide space-y-4">
              <p>
                ...
                <br />I worked primarily on the backend side of a{" "}
                <span className="font-bold text-white">Flutter-based</span>{" "}
                smart water device application, focusing on APIs, data flow, and
                ...
                <br />I optimized backend data handling and API response
                performance, reducing load times and improving real-time
                responsiveness of the application. I also worked on improving
                backend–client contracts, stabilizing API schemas, and fixing
                data-related bugs that directly impacted app behavior. In
                ...
                client distributed via the{" "}
                <span className="font-bold text-white">Play Store</span>.
              </p>
            </div>
          </div>
        </div>
